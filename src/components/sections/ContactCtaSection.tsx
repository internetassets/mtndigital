    ...
    <section id="contact" className="py-16 md:py-24 bg-blue-600 text-white">
      <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20">
          <div className="mb-8">
            <h4 className="text-xl font-semibold mb-3 text-yellow-400">Proudly Serving the White Mountains Area:</h4>
            <p className="text-md text-primary-foreground/90 leading-relaxed">
              Show Low, Pinetop-Lakeside, Snowflake, Taylor, Heber-Overgaard, Springerville, Eagar, St. Johns, Greer, Vernon, Linden, Concho, Shumway, Clay Springs, McNary, Whiteriver, Cibecue, Fort Apache, Nutrioso, Alpine.
            </p>
          </div>
